...
| REQ-CAL-006 | Frequencies reported shall be consistent across captures to within 100 Hz. | T | `test_a_drifting_handset_is_still_one_emitter`, `test_a_shifted_notch_is_measured_at_its_shift`, `test_spectral_tilt_does_not_move_the_answer` | MET — consistency verified, and the absolute error now measured against two GPS-locked LTE carriers: **-0.24 +/- 0.02 ppm**, which is -107 +/- 9 Hz at 446.09375 MHz |
